import { ArrowLeft, ChevronDown, Download, MessageCircle, Settings, Keyboard, HelpCircle } from "lucide-react";
...
export default function HelpPage() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-ai-accent/30 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 px-4" style={{ backgroundImage: "url('/assets/background-5.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        {/* Background overlay */}
        <div className="absolute inset-0 bg-black/10" />
        
        <div className="container mx-auto relative z-10">
          <div className="max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-ai-accent mb-6">
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  <summary className="flex items-center gap-4 cursor-pointer list-none">
                    <div className="w-10 h-10 rounded-lg bg-ai-accent/20 flex items-center justify-center text-ai-accent shrink-0">
      ...
      <section className="py-20 px-4 border-t border-white/5">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-ai-text-muted mb-8">
              Can&apos;t find what you&apos;re looking for? Open an issue on GitHub or reach out to us directly.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a 
                href="https://github.com/adnankhan46/y-axis/issues" 
                target="_blank" 
                rel="noopener noreferrer"
                className="px-6 py-3 bg-white/5 border border-white/10 rounded-full font-medium hover:bg-white/10 transition-colors flex items-center gap-2"
              >
                Open an Issue
              </a>
              <Link 
      ...
      {/* Footer */}
      <footer className="py-8 text-center text-ai-text-muted text-sm border-t border-white/5">
        <p>© 2024 Y-Axis. Open source.</p>
      </footer>
    </main>
  );
}
