export default function VideoShowcase() {
  return (
    <section id="" className="relative pb-24 -mt-[35vh] pt-[35vh]">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-black/60 backdrop-blur-sm shadow-2xl shadow-black/50 group">
            {/* Header of the mock browser/app window */}
            <div className="h-10 border-b border-white/10 bg-white/5 flex items-center px-4 gap-2">
              <div className="w-3 h-3 rounded-full bg-red-500/50" />
              <div className="w-3 h-3 rounded-full bg-yellow-500/50" />
              <div className="w-3 h-3 rounded-full bg-green-500/50" />
              <span className="ml-4 text-sm text-ai-text-muted">Y-Axis Demo</span>
            </div>
            ...
            <div className="relative aspect-16/10 bg-black/40 overflow-hidden">
              ...
              {/* Overlay Gradient */}
              <div className="absolute inset-0 bg-linear-to-t from-black/30 to-transparent opacity-60 pointer-events-none" />
            </div>
