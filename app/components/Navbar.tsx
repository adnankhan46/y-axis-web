    ...
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl">
      <div className="glass-panel rounded-lg px-6 py-3 flex items-center justify-between shadow-ai-modal">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-semibold text-lg tracking-tight">Y-Axis</span>
        </Link>
        ...
        <button className="hidden sm:flex bg-ai-accent hover:bg-ai-accent/90 text-white text-sm font-medium px-5 py-2 rounded-xl transition-all hover:scale-105 active:scale-95 items-center gap-2 ">
          <Download size={16} />
          <Link href={chromeWebStoreLink} target="_blank" rel="noopener noreferrer" className=" transition-colors">Add to Chrome</Link>
        </button>
        <button className="sm:hidden flex bg-ai-accent hover:bg-ai-accent/90 text-white text-sm font-medium px-5 py-2 rounded-xl transition-all hover:scale-105 active:scale-95 items-center gap-2 shadow-lg shadow-ai-accent/25">
          <Download size={16} />
