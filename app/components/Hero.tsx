...
export default function Hero() {
  return (
    <>
      <section className="relative pt-16 pb-24 min-h-screen flex flex-col items-center justify-center text-center px-4 overflow-visible" style={{ backgroundImage: "url('/assets/background-1.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-medium tracking-tight mb-6 max-w-4xl mx-auto animate-in font-sans fade-in slide-in-from-bottom-8 duration-700 delay-100 text-white/90">
          ...
          <span className="text-ai-accent not-italic font-sans">long </span> <span className="text-ai-accent font-serif italic">LLM chats</span>
        </h1>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-black/60 backdrop-blur-sm shadow-2xl shadow-black/50 group animate-in fade-in slide-in-from-bottom-8 duration-700">
              ...
              <div className="h-10 border-b border-white/10 bg-white/5 flex items-center px-4 gap-2">
                ...
                <Link href="#demo" className="ml-4 text-sm text-ai-text-muted">Y-Axis Demo</Link>
              </div>
